...
$elements[] = 	array(	
				...
				'subelements' 	=> array(	
						...
						array(	
							...
							"std" 	=> "default",
							"no_first"=>true,
							"subtype" => array('Default Ruler'=>'default','Single Line'=>'default_small','Flag (with or without customt text)'=>'custom','Whitespace'=>'whitespace'),
							"slug"  => '',
							"removable"  => 'remove element'
							),
...
$elements[] =	array(	
				"dynamic"		=> 'heading',
				"name" 			=> "Heading + (Social Media and Search Bar)",
				"slug"			=> "",
				"type" 			=> "group", 
				"id" 			=> "dynamic_heading", 
				"removable"  => 'remove element',
	            ...
	            array(	"name" 	=> "Custom Heading",
				 ...
				 array(	"name" 	=> "Display search bar and social media icons?",
						"desc" 	=> "",
			...
			$elements[] =	array(	
				...
				'subelements' 	=> array(	
						...
						array(	
								...
								"desc" 	=> "Should a title and a small text excerpt of the portfolio entry be displayed?",
								"id" 	=> "portfolio_text",
								"type" 	=> "select",
								"std" 	=> "yes",
								"no_first"=>true,
