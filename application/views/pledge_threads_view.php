    <div id="wrapper">
        ...
        <div id="threadbox">
      <h1><?=$folder.' Topics'?></h1>
          <a href="http://www.berkeleysep.com/pledge_forum">Main</a><span> -> </span><a href="javascript:void(0);"><?=$folder.' Topics'?></a>
      <hr>
      
            <?=$content;?>
      
        </div>
        <?=form_open('pledge_forum/thread_action/'.strtolower($folder))?>
